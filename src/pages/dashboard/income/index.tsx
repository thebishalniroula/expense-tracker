...
export default function Table() {
  ...
  const { data: income, isLoading } = api.income.getAll.useQuery({ filters: filtersApplied ? filters : undefined })

  if (!filtersApplied && isLoading) {
    return <div className='flex justify-center items-center h-screen text-xl'>Loading...</div>
  }
  if (!filtersApplied && !income?.length) {
    return <div className='flex justify-center items-center h-screen text-xl'>No income entries yet.</div>
  }
